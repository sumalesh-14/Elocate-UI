                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        <div className="flex items-start gap-2 mb-1">
                          <IonIcon icon={location} className="text-green-600 w-5 h-5 mt-0.5" />
                      ...
                      <div>
                        <div className="flex items-start gap-2 mb-1">
                          <IonIcon icon={call} className="text-green-600 w-5 h-5 mt-0.5" />
                          <p className="text-sm font-bold text-gray-500 uppercase tracking-wider">
                            Phone Support
                          </p>
                        </div>
                      ...
                      <div>
                        <div className="flex items-start gap-2 mb-1">
                          <IonIcon icon={mail} className="text-green-600 w-5 h-5 mt-0.5" />
                          <p className="text-sm font-bold text-gray-500 uppercase tracking-wider">
                            Email Us
                          </p>
                        </div>
                      ...
                      <div className="pt-4 border-t border-gray-200">
                        ...
                        <div className="flex gap-3">
                          <Link
                            ...
                            aria-label="LinkedIn"
                          >
                            <IonIcon icon={logoLinkedin} className="w-5 h-5" />
                          </Link>
                          <Link
                            href="/"
                            className="w-10 h-10 rounded-full bg-gray-100 hover:bg-green-100 flex items-center justify-center text-gray-600 hover:text-green-600 transition-colors"
                          ...
                          >
                            <IonIcon icon={logoInstagram} className="w-5 h-5" />
                          </Link>
                          <Link
                            href="/"
                            className="w-10 h-10 rounded-full bg-gray-100 hover:bg-green-100 flex items-center justify-center text-gray-600 hover:text-green-600 transition-colors"
                            aria-label="Twitter"
                          >
                            <IonIcon icon={logoTwitter} className="w-5 h-5" />
                          </Link>
                          <Link
                            href="/"
                            className="w-10 h-10 rounded-full bg-gray-100 hover:bg-green-100 flex items-center justify-center text-gray-600 hover:text-green-600 transition-colors"
                            aria-label="WhatsApp"
                          >
                            <IonIcon icon={logoWhatsapp} className="w-5 h-5" />
                          </Link>
                        </div>
                      </div>
                    </div>
